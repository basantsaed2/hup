...
const Caetogries = () => {
  ...
  useEffect(() => {
    ...
    axios.get("https://bcknd.ticket-hub.net/api/admin/car_categories", {
      headers: {
  ...
  const handleDelete = (index, userName) => { 
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        axios.delete(`https://bcknd.ticket-hub.net/api/admin/car_category/delete/${index}`, {
          headers: {
              Authorization: `Bearer ${token}`,
            },
          })
    ...
    <div>
      ...
      <thead className="w-full">
            ...
            <th className="w-[10px] h-[56px] text-[16px] border-b text-left px-1">
              ...
              <th className="w-[158px] h-[56px]  text-[16px]  border-b text-left"></th>
          ...
          <tbody>
            ...
            {paginatedData.map((item, index) => (
                ...
                <td className="w-[143px]  h-[56px]  text-[16px]  text-nine  "></td>
