...
const BRANDS = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/car_brands", {
        headers: {
  ...
  const handleDelete = (index, userName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://bcknd.ticket-hub.net/api/admin/car_brand/delete/${index}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
              ...
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <td className="flex gap-1 px-2 ">
                    ...
                    />
                    <span className="w-[143px] h-[56px]  text-[16px] px-1">
                      {item?.name ?? "N//A"}
                    </span>
                  </td>
