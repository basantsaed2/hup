...
const AddMODELS = () => {
  ...
  useEffect(() => {
    ...
    const paymentActions = roles
      .filter((role) => role.module === "car_models")
  ...
  const handleSave = () => {
    ...
    if (edit) {
      ...
      axios
        .put(
          `https://bcknd.ticket-hub.net/api/admin/car_model/update/${sendData.id}`,
          newCountryData,
          {
            headers: {
    ...
    axios
      .post(
        "https://bcknd.ticket-hub.net/api/admin/car_model/add",
        newCountryData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="ml-6 flex flex-col mt-6 gap-6">
      <AddAll navGo="/Car/MODELS" name={edit ? "Edit MODELS" : "Add MODELS"} />
