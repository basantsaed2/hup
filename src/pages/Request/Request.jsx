...
const Request = () => {
  ...
  useEffect(() => {
    ...
    const paymentActions = roles
      .filter((role) => role.module === "trip_request")
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/trip_request", {
        headers: {
  ...
  const filteredData = data.filter((item) => {
    ...
    switch (selectedFilter) {
      ...
      case "trip_type":
        return item.trip_type?.toLowerCase().includes(query);
  ...
  const handleStatusChange = (ids, newStatus) => {
    ...
    axios
      .put(
        `https://bcknd.ticket-hub.net/api/admin/trip_request/status/${ids}`,
        {
