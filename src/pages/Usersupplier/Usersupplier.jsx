...
const Usersupplier = () => {
  ...
  useEffect(() => {
    ...
    axios.get("https://bcknd.ticket-hub.net/api/admin/user_request", {
      headers: {
      ...
      status: "status",
        ...
        const handleStatusChange=(id,trag)=>{
            if(trag==="Pending")return
              axios.put(`https://bcknd.ticket-hub.net/api/admin/user_request/status/${id}`, {
                status:trag
              }, {
                headers: {
                    Authorization: `Bearer ${token}`,
              ...
              <table className="w-full  border-y border-x border-black">
                <thead className="w-full">
                  ...
                  <th className="w-[10px] h-[56px] text-[16px] border-b text-left px-1">S/N</th>
                    ...
                    <th className="w-[158px] h-[56px] text-[14px] border-b text-left">Email </th>
                ...
                <tbody>
                  {paginatedData.map((item, index) => (
                      ...
                      <td className="w-[143px] h-[56px] text-[16px] px-4">{item?.phone??"N//A"}</td>
                      <td className="w-[143px] h-[56px] text-[14px] ">{item?.email??"N//A"}</td>
