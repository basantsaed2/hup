...
const AddPaymentMethods = () => {
  ...
  useEffect(() => {
    ...
    const paymentActions = roles
      .filter((role) => role.module === "payment_methods")
  ...
  const handleSave = () => {
    ...
    if (edit) {
      ...
      axios
        .put(
          `https://bcknd.ticket-hub.net/api/admin/payment_method/update/${sendData.id}`,
          newCountryData,
          {
            headers: {
    ...
    axios
      .post(
        "https://bcknd.ticket-hub.net/api/admin/payment_method/add",
        newCountryData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="ml-6 flex flex-col mt-6 gap-6">
      <AddAll
        navGo="/Settings/PaymentMethods"
        name={edit ? "Edit Payment Methods" : "Add Payment Methods"}
      />
