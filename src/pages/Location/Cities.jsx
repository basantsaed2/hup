...
const Cities = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/cities", {
        headers: {
  ...
  const handleDelete = (index, cityName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://bcknd.ticket-hub.net/api/admin/city/delete/${index}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
          ...
          .then(() => {
            ...
            Swal.fire(
              "Deleted!",
              `${cityName} has been deleted successfully.`,
              "success"
            );
          })
          .catch(() => {
            Swal.fire(
              "Error!",
              `There was an error while deleting ${cityName}.`,
              "error"
            );
          });
      } else {
