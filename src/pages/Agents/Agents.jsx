...
const Agents = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/operators", {
        headers: {
  ...
  const handleDelete = (index, userName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://bcknd.ticket-hub.net/api/admin/operator/delete/${index}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <td className="w-[143px] h-[56px]  lg:text-[10px] xl:text-[12px] px-2  ">
                    {item?.name ?? "N//A"}
                  </td>
