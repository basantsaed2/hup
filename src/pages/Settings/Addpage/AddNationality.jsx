...
const AddNationality = () => {
  ...
  const handleSave = () => {
    ...
    if (edit) {
      ...
      axios
        .put(
          `https://bcknd.ticket-hub.net/api/admin/nationality/update/${sendData.id}`,
          newCountryData,
          {
            headers: {
    ...
    axios
      .post(
        "https://bcknd.ticket-hub.net/api/admin/nationality/add",
        newCountryData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="ml-6 flex flex-col mt-6 gap-6">
      <AddAll
        navGo="/Settings/Nationality"
        name={edit ? "Edit Nationality" : "Add Nationality"}
      />
