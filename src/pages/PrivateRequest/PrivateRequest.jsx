...
const PrivateRequest = () => {
  ...
  useEffect(() => {
    ...
    const paymentActions = roles
      .filter((role) => role.module === "private_request")
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/private_request", {
        headers: {
  ...
  const handleStatusChange = (agid) => {
    ...
    axios
      .post(
        `https://bcknd.ticket-hub.net/api/admin/private_request/determin_agent`,
        {
          agent_id: agid,
        ...
        <table className="w-full  border-y border-x border-black">
          <thead className="w-full">
            <tr className="bg-four w-[1012px] h-[56px]">
              <th className="w-[10px] h-[56px] text-[10px] border-b text-left px-1">
                S/N
              </th>
              ...
              <th className="w-[200px] h-[56px] text-[12px] border-b text-left pl-3">
                From{`-->`}To{" "}
              </th>
          ...
          <tbody>
            {paginatedData.map((item, index) => (
              ...
              >
                ...
                <td className="w-[143px] h-[56px] text-[10px] px-4">
                  {item?.user?.name ?? "N//A"}
                </td>
                <td className="w-[143px] h-[56px] text-[10px] px-4">
                  {item?.address ?? "N//A"}
                </td>
                <td className="w-[180px] h-[56px] text-[10px] px-4">
                  {item?.from_city?.name ?? "N//A"}
                  {`-->`}
                  {item?.to_city?.name ?? "N//A"}
                </td>
                ...
                <td className="w-[143px] h-[56px] text-[10px] px-1">
                ...
                <td className="w-[143px] h-[56px] text-[16px] flex justify-start gap-2 items-center">
                  <button
                    ...
                    className="bg-three rounded-4xl text-white py-2 px-4 "
                  >
                    Agant
                  </button>
                </td>
