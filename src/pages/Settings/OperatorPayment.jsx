...
const OperatorPayment = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/operator_payment_methods", {
        headers: {
  ...
  const handleDelete = (index, userName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://bcknd.ticket-hub.net/api/admin/operator_payment_method/delete/${index}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
      ...
      <div>
        <div className="flex justify-between items-center mt-10 px-5">
          ...
          {actions.includes("add") ? (
            <ThreeThing
              navGo="/Settings/AddOperatorPayment"
              labelMap={labelMap}
