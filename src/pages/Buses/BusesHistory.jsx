...
const BusesHistory = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://bcknd.ticket-hub.net/api/admin/aminites", {
        headers: {
  ...
  const handleDelete = (index, userName) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            `https://bcknd.ticket-hub.net/api/admin/aminity/delete/${index}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <td>
                    <img className="w-5 h-5" src={item.icon_link} />
                  </td>
                ...
                <div key={index} className="flex flex-col gap-4 p-3">
                  ...
                  <div className="flex gap-4">
                    ...
                    <img
                      ...
                      src={
                        item.icon_link === null
                          ? `data:image/png;base64,${item.icon_link}`
                          : item.icon_link
                      }
                    />
                  </div>
