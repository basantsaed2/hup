...
import CarTotal from '../../IconsImprot/CarTotal';
import Revenue from '../../IconsImprot/Revenue';
import Graf from '../../IconsImprot/Graf';
...
<div className='w-[23%} h-[159px] bg-threeteen  text-three flex flex-col  gap-6 p-8'>
  <div className='flex gap-1  text-[16px] md:text-[20px] lg:text-2xl  items-center'><i><FaUsers className='text-three'/></i><span>Total Users </span> </div>
  <span className='text-2xl'> 100</span>
</div>
{/* two */}
<div className='w-[23%} h-[159px] bg-fourteen  text-one flex flex-col  gap-6 p-8'>
  <div className='flex gap-1  text-[16px] md:text-[20px] lg:text-2xl items-center'><i><IconAgents active/></i><span>Active Agents</span> </div>
  <span className='text-2xl'> 100</span>
</div>
...
<div className='w-[23%} h-[159px] bg-threeteen text-three  text-one flex flex-col  gap-6 p-8'>
  <div className='flex gap-1  text-[16px] md:text-[20px] lg:text-2xl  items-center'><i><CarTotal active/></i><span>Total Cars </span> </div>
  <span className='text-2xl'> 100</span>
</div>
{/* four */}
<div className='w-[23%} h-[159px] bg-fourteen  text-one flex flex-col  gap-4 p-8'>
  <div className='flex gap-1  text-[16px] md:text-[18px] lg:text-[20px]  items-center'><i><Revenue /></i><span>Total Revenue </span> </div>
  <span className='text-2xl'> 100</span>
</div>
</div>
<div>
